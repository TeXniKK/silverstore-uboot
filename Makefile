...
ifeq ($(BE),)
ifeq ($(CSL),)
	@echo "CROSS_COMPILE = arm-mv5sft-linux-gnueabi-" >> include/config.mk;
else	
...
#=================================================
# Board Type config, Jean 2011-05-27
#=================================================
ifeq ($(BAY),4)
	@echo "** USI Build Borad NV+V4" ;
	@echo "MV_FLAGS += -DUSI_BOARD_NVPLUS_V4" >> include/config.mk;
else
	@echo "** USI Build Board DUOV3" ;
	@echo "MV_FLAGS += -DUSI_BOARD_DUO_V3" >> include/config.mk;
endif
