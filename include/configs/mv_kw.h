...
#define CONFIG_IDENT_STRING	" Marvell version: 3.4.27\nNetgear version: Uboot-1_1_4-NetgearNV+V4-V1008"
#else
#define CONFIG_IDENT_STRING	" Marvell version: 3.4.27\nNetgear version: Uboot-1_1_4-NetgearDUOV3-V1008"
#endif
//add version in cmdline so as to get it in kernel
#endif /* MV_TINY_IMAGE */
#define USISH_UBOOT_BOOTARGS "console=ttyS0,115200;"
#define USISH_UBOOT_BOOTCMD "nand read.e 0x1200000 0x200000 0x600000;nand read.e 0x2000000 0x800000 0x1000000;bootm 0x1200000 0x2000000"
/* libo 2010-07-01 */
...
/* libo 2010-07-01 */
#define CONFIG_IPADDR		192.168.58.21
#define CONFIG_SERVERIP		192.168.58.135
/* libo 2010-07-01 */
...
//#define CFG_ENV_OFFSET				(896 << 10)	/* environment starts here  */
#define CFG_ENV_OFFSET				(0x180000)	/* environment starts here  */
...
#ifdef MV_SPI_BOOT
#undef CFG_ENV_ADDR
#define CFG_ENV_ADDR 0xf807f000
#undef CFG_ENV_SECT_SIZE
